...
public class SampleUseOfMenu {  // Class representing the MenuCLI process to be used
...
//                           keyboard   screen
		...
		final String   MAIN_MENU_OPTION_3    = "Option three Description";
		...
		while(shouldLoop) {         // Loop while loop control variable is true
			 ...
			 * 
			 * Menu class requires a String array with options you want to present to the user
			 * 
			 * Use the menu.getChoiceFromOptions() to display options and get user's choice
			 * 
			 ...
			 ****************************************************************************/ 
			// Cast the choice to a String as the getChoiceFromeOptions method returns a generic object
			//
			// the method returns teh actual word in the option NOT The number assigned to the options
