...
INSERT INTO survey_result(parkCode, emailAddress, state, activityLevel) VALUES ('RMNP', 'ricky@shanygne.com', 'OH', 'sedentary');
INSERT INTO survey_result(parkCode, emailAddress, state, activityLevel) VALUES ('RMNP', 'shanygne@ricky.com', 'OH', 'inactive');
INSERT INTO survey_result(parkCode, emailAddress, state, activityLevel) VALUES ('RMNP', 'ricky@shanygne.com', 'OH', 'sedentary');
INSERT INTO survey_result(parkCode, emailAddress, state, activityLevel) VALUES ('RMNP', 'shanygne@ricky.com', 'OH', 'inactive');
INSERT INTO survey_result(parkCode, emailAddress, state, activityLevel) VALUES ('CVNP', 'spencersucks@yahoo.com', 'FL', 'inactive');
INSERT INTO survey_result(parkCode, emailAddress, state, activityLevel) VALUES ('CVNP', 'spencersucks@yahoo.com', 'FL', 'inactive');
INSERT INTO survey_result(parkCode, emailAddress, state, activityLevel) VALUES ('CVNP', 'spencersucks@yahoo.com', 'FL', 'inactive');
INSERT INTO survey_result(parkCode, emailAddress, state, activityLevel) VALUES ('YNP', 'capstone3@te.com', 'OH', 'extremely active');
INSERT INTO survey_result(parkCode, emailAddress, state, activityLevel) VALUES ('GSMNP', 'cohort13@te.com', 'OH', 'active');